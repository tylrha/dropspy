...
export default class Spybot {
  ...
  //       const isLoggedInAlihunter = await checkAlihunterLogin(alihunterPage)
  //       if (!isLoggedInAlihunter) {
  //         // await saveScreenShot(alihunterPage)
  //         throw new Error("Erro ao logar no alihunter")
  //       }
  ...
  //       // const isLoggedInFacebook = await checkGoogleLogin(facebookPage)
